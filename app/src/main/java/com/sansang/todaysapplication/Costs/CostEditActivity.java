...
public class CostEditActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        edtxt_csid = findViewById( R.id.edtxt_cost_edit_csid );
        edtxt_date = findViewById( R.id.edtxt_cost_edit_date );
        edtxt_site = findViewById( R.id.edtxt_cost_edit_site );
        edtxt_detail = findViewById( R.id.edtxt_cost_edit_detail );
        edtxt_price = findViewById( R.id.edtxt_cost_edit_price );
        edtxt_amount = findViewById( R.id.edtxt_cost_edit_amount );
        edtxt_memo = findViewById( R.id.edtxt_cost_edit_memo );
    ...
    private void getIntentResult() {
        ...
        String csid = positionIntent.getExtras().getString( "csid" ); //String 형
        String date = positionIntent.getExtras().getString( "date" );
        String site = positionIntent.getExtras().getString( "site" );
        String detail = positionIntent.getExtras().getString( "detail" );
        int price = positionIntent.getExtras().getInt("price");
        ...
        edtxt_csid.setText( csid );
        edtxt_date.setText( date );
        edtxt_site.setText( site );
        edtxt_detail.setText( detail );
        edtxt_price.setText(String.valueOf(price));
    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        switch (item.getItemId()) {
            case R.id.toolbar_edit_update:
                if (edtxt_site.length() == 0 || edtxt_amount.length() == 0){
                    Toast.makeText( CostEditActivity.this,
                            "현장 또는 경비 금액을 입력 하세요?", Toast.LENGTH_SHORT ).show();
                }else {
                    String csid = edtxt_csid.getText().toString();
            ...
            case R.id.toolbar_delete_update:
                ...
                if (edtxt_id.length() > 0){
                    ...
                    Intent updateintent = new Intent( getApplicationContext(), CostListActivity.class );
                    startActivity( updateintent );

                    finish();
                }else {
                    Toast.makeText( CostEditActivity.this,
                            "Not Deleted" + csid, Toast.LENGTH_LONG ).show();
                }
                return true;

            case R.id.toolbar_close_update:
                Toast.makeText(getApplicationContext(),
                        "경비 수정 끝내기", Toast.LENGTH_SHORT).show();
